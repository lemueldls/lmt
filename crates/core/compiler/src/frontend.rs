...
peg::parser!(pub grammar parser() for str {
    ...
    rule binary_op() -> Expr = precedence!{
        ...
        --
        i:identifier() _ "(" args:((_ e:labeled_expression() _ {e}) ** ",") ")" { Expr::Call(i, args) }
        "@" _ i:identifier() _ "(" args:((_ e:labeled_expression() _ {e}) ** ",") ")" { Expr::MacroCall(i, args) }
